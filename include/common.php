...
function printFooter() {
	...
	<p style='margin-top: -5px; font-size: 8pt; text-align: center'>Current version of update branch on GitHub: <a href="https://github.com/interiorcodealligator/phpki/releases/tag/v0.21.1">v0.21.1</a></p>
	</body>
	</html>
	<?php
}
