...
case 'write':
	...
	#Replaced all occurrences of "\$config" with "$config" below. Must test
...
E-mail: <a href=mailto:someone@somewhere.com>someone@somewhere.com</a>&nbsp;&nbsp;&nbsp;<i><b>E-mail is preferred.</b></i><br>';
	...
	<td><input type="text" name="contact" value="<?php print htvar($contact) ?>" maxlength="60" size="30"></td>
	</tr>

	<tr>
	<td><strong>Locality</strong> <font color="red">*</font></td>
	<td><input type="text" name="locality" value="<?php print htvar($locality) ?>" maxlength="60" size="30"></td>
	</tr>

	<tr>
	<td><strong>State/Province</strong> <font color=red>*</font></td>
	<td><input type="text" name="province" value="<?php print htvar($province) ?>" maxlength="60" size="20"></td>
	</tr>

	<tr>
	<td><strong>Country</strong> <font color="red">*</font></td>
	<td><input type="text" name="country" value="<?php print htvar($country) ?>" maxlength="2" size="2"></td>
	</tr>
...
'" : "") . " >$i bits</option>\n" ;
	...
	<td>
	<input type="text" name="base_url" value="<?php print htvar($base_url) ?>" size="50">
	</td>
	</tr>
	...
	<td>
	<input type="text" name="store_dir" value="<?php print htvar($store_dir) ?>" size="35">
	</td>
	</tr>
	...
	<td>
	<input type="text" name="openssl_bin" value="<?php print htvar($openssl_bin) ?>" size="35">
	</td>
	</tr>
	...
	<td>
	<input type="text" name="passwd_file" value="<?php print htvar($passwd_file) ?>" size="35">
	</td>
	</tr>
	...
	<td>
	<input type="text" name="header_title" value="<?php print htvar($header_title) ?>" maxlength="40" size="40">
	</td>
	</tr>
	...
	<td>
	<textarea name="getting_help" cols="50" rows="15"><?php print htvar($getting_help) ?></textarea>
	</td>
	</tr>
	</table>
